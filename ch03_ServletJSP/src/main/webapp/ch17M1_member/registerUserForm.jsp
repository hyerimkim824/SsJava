		...
		<form action="registerUser.jsp" method="post" id="register_form">
			...
			<ul>
				...
				<li><label for="id">아이디</label> <input type="text" name="id"
					id="id" class="input-check" size="7" maxlength="12"
					autocomplete="off"> <input type="button" id="confirm_id"
					value="ID중복확인"> <span id="id_signed"></span></li>
				<li><label for="name">이름</label> <input type="text" name="name"
					id="name" class="input-check" maxlength="10"></li>
				...
				<li><label for="email">이메일</label> <input type="email"
					name="email" id="email" class="input-check" maxlength="50">
				</li>
