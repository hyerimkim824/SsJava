	...
	<div class="content-main">
		...
		<div class="mypage-div">
			...
			<c:if test="${user_auth!=9}">
				<input type ="button" value ="관리자와 채팅(${chatCount})" onclick ="location.href='${pageContext.request.contextPath}/chatone/chatDetail.do'">
				
			</c:if>
			
			<c:if test="${user_auth==9}">
				<input type ="button" value ="채팅 목록(${chatCount})" onclick ="location.href='${pageContext.request.contextPath}/chatone/adminchatDetail.do'">
