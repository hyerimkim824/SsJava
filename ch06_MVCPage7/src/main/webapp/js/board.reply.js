$(function(){
	...
	$('#re_form').submit(function(event){
		...
		//form 이하의 태그에 입력한 데이터를 모두 읽어서 쿼리 스트링으로
		//반환
	...
	$(document).on('click','.modify-btn',function(){
		...
		//이전에 이미 수젛아는 댓글이 있을 경우 수정버튼을 클릭하면 숨김 sub-item 클래스로 지정한 div를 환원시키고 수정폼을 제거
