			...
			<table>
				...
				<tr>
					...
					<td class="align-center">
						...
						<c:if test="${cart.itemVO.quantity < cart.itemVO.quantity}">[수량부족]<br><small>삭제 후 재고 수량 확인</small></c:if>
						<c:if test="${cart.itemVO.status==2 and 
						             cart.itemVO.quantity >= cart.order_quantity}">
