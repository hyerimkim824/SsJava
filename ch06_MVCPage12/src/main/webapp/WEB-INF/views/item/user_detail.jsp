...
<script type="text/javascript"
	...
	<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/shop.item-detail.js"></script>
</head>
<body>
<div class="page-main">
			...
			<div class="item-detail">
				<form id="item_cart">
					...
					<ul>
                        ...
                        <li>가격 : <b><fmt:formatNumber value="${item.price}" /></b>
                        </li>
                        <li>수량 : <b><fmt:formatNumber value="${item.quantity}" /></b>
                        </li>
                        <c:if test="${item.quantity>0}">
                            <li><label for="order_quantity">구매수량</label> <input
                                type="number" name="order_quantity" min="1"
                                max="${item.quantity}" autocomplete="off" id="order_quantity"
                                class="quantity-width>"></li>
                            <li><span id="item_total_txt"> 총 주문금액 : 0원</span></li>
