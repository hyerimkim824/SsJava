...
public class CalendarMain01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(today); //매우 많은 형태가 있다.
		
		int year = today.get(Calendar.YEAR);// 연도
		int month = today.get(Calendar.MONTH)+1;//월 0~11월
		...
		String str = amPm ==Calendar.AM ? "오전" : "오후"; //삼항 연산자
		                                //오전 0, 오후 1
		
		//0~11, 정오와 자정은 12 아니라 0으로
		int hour = today.get(Calendar.HOUR); //시 HORE_OF_DAY
